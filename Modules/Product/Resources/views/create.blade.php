...
@section ('title', trans('product::labels.backend.product.management') . ' | ' . trans('product::labels.backend.product.create'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('product::labels.backend.product.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.product.store', 'class' => 'form-horizontal', 'files' => true ,'role' => 'form', 'method' => 'post', 'id' => 'create-product']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('product::labels.backend.product.create') }}</h3>
