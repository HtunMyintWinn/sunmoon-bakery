...
class ProductDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $create_permission->display_name = 'Create Product';
        ...
        $edit_permission->display_name = 'Edit Product';
        ...
        $delete_permission->display_name = 'Delete Product';
