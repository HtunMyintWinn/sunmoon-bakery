...
@section ('title', trans('productcategory::labels.backend.productcategory.management') . ' | ' . trans('productcategory::labels.backend.productcategory.create'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('productcategory::labels.backend.productcategory.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.productcategory.store', 'class' => 'form-horizontal', 'files' => true ,'role' => 'form', 'method' => 'post', 'id' => 'create-productcategory']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('productcategory::labels.backend.productcategory.create') }}</h3>
            ...
            <div class="box-body">           
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10" style="margin-top: 4px;">
                        {{ Form::checkbox('status','1', ['class' => 'form-control', 'placeholder' => trans('productcategory::labels.backend.productcategory.table.status')]) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
            </div><!-- /.box-body -->
        </div><!--box-->
