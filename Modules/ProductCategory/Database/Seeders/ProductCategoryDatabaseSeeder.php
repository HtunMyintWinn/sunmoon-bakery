...
class ProductCategoryDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $module = strtolower('ProductCategory');
        $permission_model = config('access.permission');
        $view_permission = new $permission_model();
        $view_permission->name = 'view-'.$module;
        $view_permission->display_name = 'View ProductCategory';
        ...
        $create_permission->display_name = 'Create ProductCategory';
        ...
        $edit_permission->display_name = 'Edit ProductCategory';
        ...
        $delete_permission->display_name = 'Delete ProductCategory';
