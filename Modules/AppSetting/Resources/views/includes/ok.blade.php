<div class="caption text-center">
 <span style="text-decoration: underline;font-size: 20px">OK</span>
</div>

<div class="form-group row">                       
<label for="ok_enable" class="col-md-2 control-label">OK Payment</label>
    <div class="col-md-10">
   <div class="md-checkbox">
            <input type="checkbox" name="ok_enable" id="ok_enable" {{ (config('payment.ok.enable'))?'checked="checked"':'' }} value="true" class="md-check">
            <label for="ok_enable">
             <span class=""></span>
