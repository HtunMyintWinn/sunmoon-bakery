...
class ShopDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $create_permission->display_name = 'Create Shop';
        ...
        $edit_permission->display_name = 'Edit Shop';
        ...
        $delete_permission->display_name = 'Delete Shop';
