...
@section ('title', trans('shop::labels.backend.shop.management') . ' | ' . trans('shop::labels.backend.shop.edit'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('shop::labels.backend.shop.edit') }}</small>
    </h1>
@endsection

@section('content')
    
    {{ Form::model($shop, ['route' => ['admin.shop.update', $shop], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-shop']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('shop::labels.backend.shop.edit') }}</h3>
