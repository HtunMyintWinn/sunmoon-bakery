...
class OrderDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $create_permission->display_name = 'Create Order';
        ...
        $edit_permission->display_name = 'Edit Order';
        ...
        $delete_permission->display_name = 'Delete Order';
